...
3. **算 5 维分数** — 25 款全部算一遍
4. **抗聚堆排序** — 同分类最多 2 个；**最终 7 个里相邻两张不能同 A-E 大类**（破"3 张华丽璀璨连排"的刻意感）
5. **生成 title + style_tags + reason**
    - `style_tags`：从 STYLE_TO_USER_TAGS 反查（猫眼 / 杏仁款 / 帕斯蒂尔风 / 韩系 / 多巴胺 / 清冷感 / 甜酷风格 / 裸色系 / 显白夏天 / 简约高级 / 中短款 / 本甲款 / 独特小众），取 1-3 个
    - `title`：形如「工艺 · 意象」（2-6 字 + 间隔点 + 2-6 字），工艺取自 style_tags 第一项；意象由 AI 自由发挥（暗夜冰川 / 奶咖软香 / 蜜糖柑橘…）
    - `reason`：挑 W·X 乘积最大的那个维度作为理由，**1-2 句话**讲为什么推给这个用户
6. **输出报告** — 严格按下面 schema

# 25 款 → user_tag 反查（生成 style_tags 用）

```
A 简约清透
  nail_01: 简约高级/清冷感/本甲款    nail_10: 显白夏天/韩系/裸色系
  nail_13: 中短款/简约高级/本甲款    nail_14: 杏仁款/简约高级/裸色系
  nail_23: 韩系/清冷感/显白夏天
B 甜美可爱
  nail_02: 帕斯蒂尔风/韩系           nail_05: 甜酷风格/帕斯蒂尔风
  nail_15: 帕斯蒂尔风/裸色系/显白夏天  nail_16: 甜酷风格/帕斯蒂尔风
  nail_25: 帕斯蒂尔风/韩系/中短款
C 华丽璀璨
  nail_06: 猫眼/独特小众             nail_11: 猫眼/独特小众
  nail_17: 独特小众/甜酷风格         nail_18: 猫眼
  nail_19: 独特小众/猫眼
D 暗黑酷飒
  nail_03: 甜酷风格/独特小众         nail_08: 独特小众/中短款
  nail_09: 甜酷风格/独特小众         nail_12: 独特小众/甜酷风格
E 潮流前卫
  nail_04: 多巴胺/独特小众           nail_07: 多巴胺/杏仁款
  nail_20: 独特小众/杏仁款           nail_21: 多巴胺/独特小众
  nail_22: 杏仁款/独特小众           nail_24: 多巴胺/杏仁款
```
...
**已废弃字段，不要再输出**：`category` / `category_name` / `score` / `score_breakdown` / `business_insight`。
- 前两个：分类是后端筛选用、不该露给 C 端用户（用户看到 "C 华丽璀璨" 感觉很冷）
- score / score_breakdown：内部打分细节，C 端用户不需要
- business_insight：给运营/商家的建议——C 端用户看自己的报告里教商家做生意很怪
...
4. **style_tags 必须从 13 个 user_tag 里选** —— 不允许自创 tag；猫眼/杏仁款 这种工艺/形状 tag 跟 A-E 大类正交，可以跨分类混搭
5. **相邻不同大类** —— 7 张推荐排序时相邻 2 张的 A-E 大类不能相同；这是避免感觉刻意聚堆的硬约束
